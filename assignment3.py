...
#Q5
p = int(input("Enter the number of hydrogen atoms: "))
q = int(input("Enter the number of carbon atoms: "))
s = int(input("Enter the number of oxygen atoms: "))

wt_p = p*1.00794
wt_q = q*12.0107
wt_s = s*15.99994

print(wt_p + wt_q + wt_s)
